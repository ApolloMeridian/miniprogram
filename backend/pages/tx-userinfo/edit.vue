  ...
  "total_people": ""
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field('sex,age,education,occupation,income_min,income_max,private_car,construction_area,bicycle,housing_nature,total_people').get().then((res) => {
